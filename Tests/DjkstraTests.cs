...
namespace SaveTheCommunism.Tests
{
    ...
    public class ExtensionsTests
    {
        ...
        {
            var player = new Player(10, 2, new Vector(10, 10), new Vector(1, 2), new Vector(2, 1));
        ...
        {
            var player = new Player(10, 2, new Vector(10, 10), new Vector(1, 2), new Vector(2, 1));
            var enemy = new Enemy(10, 2, new Vector(8, 10), new Vector(1, 2), new Vector(2, 1));
        ...
        {
            var player = new Player(10, 2, new Vector(10, 10), new Vector(1, 2), new Vector(2, 1));
            var enemy1 = new Enemy(10, 2, new Vector(10, 9), new Vector(1, 2), new Vector(2, 1));
            var enemy2 = new Enemy(10, 2, new Vector(8, 10), new Vector(1, 2), new Vector(2, 1));
