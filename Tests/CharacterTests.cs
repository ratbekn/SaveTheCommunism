...
namespace SaveTheCommunism.Tests
{
    ...
    {
        public TestCharacter(int health, int damage, Vector position, Vector speed, Vector velocity)
    ...
    public class CharacterTests
    {
        ...
        public void TestHit()
        {
            var character1 = new TestCharacter(10, 2, new Vector(10, 10), new Vector(1, 2), new Vector(2, 1));
            var character2 = new TestCharacter(10, 3, new Vector(10, 15), new Vector(1, 2), new Vector(2, 1));
        ...
        {
            var character1 = new TestCharacter(10, 2, new Vector(10, 10), new Vector(1, 2), new Vector(2, 1));
            var character2 = new TestCharacter(2, 3, new Vector(10, 15), new Vector(1, 2), new Vector(2, 1));
            character1.Hit(character2);
        ...
        {
            var character = new TestCharacter(10, 2, new Vector(10, 10), new Vector(1, 2), new Vector(2, 1));
        ...
        {
            var character = new TestCharacter(10, 2, new Vector(10, 10), new Vector(1, 1), new Vector(1, 1));
            for (var i = 0; i < 4; i++)
